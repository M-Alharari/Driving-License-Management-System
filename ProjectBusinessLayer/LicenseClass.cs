...
namespace ProjectBusinessLayer
{
    public class clsLicenseClass
    {
        ...
        public clsLicenseClass(int LicenseClassID, string ClassName, string LicenseDescription, byte MinimumAllowedAge, byte DefaultValidityLength, float ClassFees)
        {
